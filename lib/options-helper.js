...
var
    ...
    valueMap = {
        'false': optionsMap.ignore,
        '': optionsMap.warnings,
        'true': optionsMap.errors,

        '0': optionsMap.ignore,
        '1': optionsMap.warnings,
        '2': optionsMap.errors
    };
...
module.exports = {
    ...
    filterUnknown: function (options, where) {
        ...
        within = where? optionsDic[where]: _.merge(optionsDic.cliOnly, optionsDic.cliAndRc);
    ...
    externalRcOptions: function (path) {
        return this.parseRc(fs.readFileSync(path).toString());
    }
};
